...
O desenvolvimento do biblioteca de leitura do mouse foi realizado com base na [documentação do kernel Linux](https://www.kernel.org/doc/html/latest/index.html) Além de analises e testes realizados em laboratório com os documentos e informações.
